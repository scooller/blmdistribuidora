...
$logo=get_field('logo_blanco','option');
$logo_site=get_sitelogo(false);
//--
?>
<!DOCTYPE html>
...
<body <?php body_class(); ?>>
	...
	<div class="container-fluid">
		<nav id="menu" class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="<?php echo home_url( '/' ); ?>"><img src="<?=$logo?>" alt="" class="logo-negative"><img src="<?=$logo_site?>" alt="" class="logo"></a>
